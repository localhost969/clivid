...
- Each step should have complete parameters, use "extracted_audio" for file references between steps"""
    ...
    def execute_list_videos(self):
        ...
        try:
            result = subprocess.run([sys.executable, 'tasks/list_videos.py'], 
            ...
            if result.returncode == 0:
                ...
                return f"Error listing videos: {result.stderr}"
        except Exception as e:
            print(f"[!] Error: {e}")
            return f"Error: {e}"
    ...
    def execute_video_info(self, video_file):
        ...
        try:
            ...
            import video_info
            video_info.display_video_info(video_file)
    ...
    def execute_extract_audio_segment(self, video_file, start_time, end_time=None, audio_format=None, quality=None):
        ...
        try:
            import tasks.extract_audio_segment as audio_segment_module
    ...
    def execute_replace_audio(self, video_file, audio_file, audio_handling=None, audio_codec=None):
        ...
        if not audio_file or audio_file not in audio_files:
        ...
        try:
            import tasks.replace_audio as replace_audio_module
            import os
    ...
    def show_help(self):
        ...
        print("  ↳ All steps execute automatically - no need to say 'continue'!")
        print("")
    ...
    def run(self):
        ...
        print("Type 'help' for examples, or just tell me what you want to do!")
        print("=" * 40)
